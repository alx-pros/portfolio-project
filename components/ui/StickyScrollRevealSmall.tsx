...
export const StickyScrollRevealSmall = ({
    ...
    const checkStickyState = () => {
      ...
      contentRefs.current.forEach((contentEl, index) => {
        ...
        textElements.forEach((textEl) => {
          ...
          const isOverlap = !(
            stickyRect.bottom < textRect.top + 10 || stickyRect.top > textRect.bottom - 10
          );
  ...
  return (
    <div className="relative mx-auto px-4 py-10">
      ...
      <div className="md:hidden relative" ref={ref}>
          ...
          {content.map((item, index) => {
            ...
            return (
              <div
                ...
                className="relative min-h-[550px] flex flex-col justify-start"
              >
                <motion.h2
        ...
        <motion.div
          ...
          className={cn(
            "sticky bottom-14 left-0 right-0 h-[180px] w-full rounded-xl transition-colors duration-500 overflow-hidden z-0",
            contentClassName
          )}
        >
